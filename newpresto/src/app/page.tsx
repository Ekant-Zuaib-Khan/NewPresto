            ...
            <div className="col-span-5 grid grid-cols-2 gap-10 ">
              <div className="flex flex-col gap-4">
                <h2 className="text-2xl">
                  Please take a moment to fill <br /> in the details and our team shall <br />
                ...
                <div className="grid grid-cols-3 gap-3">
                  <Image src={FirstLogo} alt="firstLogo" loading="lazy" className="border rounded-md p-1 border-black" />
                  <Image src={SecLogo} alt="firstLogo" loading="lazy" className="border rounded-md p-1 border-black" />
                  <Image src={ThirdLogo} alt="firstLogo" loading="lazy" className="border rounded-md p-1 border-black" />
                </div>
              </div>
              ...
              <div className="border border-gray-300 bg-white p-5">
                ...
                <input type="text" placeholder="Name" className="contactInput"/>
                <input type="text" placeholder="Name" className="contactInput"/>
                <textarea rows={3} placeholder="Name" className="contactInput !mb-1"/>
                <button className="bg-primaryColor text-white w-full rounded-md py-2">submit</button>
              </div>
            </div>
            <div  />
          </div>
